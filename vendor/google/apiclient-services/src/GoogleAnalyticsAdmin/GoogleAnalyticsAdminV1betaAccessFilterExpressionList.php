...
class_alias(GoogleAnalyticsAdminV1betaAccessFilterExpressionList::class, 'Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1betaAccessFilterExpressionList');
